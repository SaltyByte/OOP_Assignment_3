...
def check3():
    ...
    g_algo.load_from_json(file)
    dest, path = g_algo.shortest_path(0, 71)
    print(dest, path)
    dest, path = g_algo.shortest_path(69, 15)
    print(dest, path)
    file = '../data/G_1000_8000_1.json'
    g_algo.load_from_json(file)
    dest, path = g_algo.shortest_path(69, 420)
    print(dest, path)
    dest, path = g_algo.shortest_path(420, 69)
    print(dest, path)
    dest, path = g_algo.shortest_path(768, 0)
    print(dest, path)
